    ...
    const [newMember, setNewMember] = useState({
        ...
        last_name: '',
        birthday: '',
        image: { name: '', type: '', url: defaultProfile, description: '' },
    ...
    return (
        ...
        <Modal isOpen={modalOpen} onClose={closeModal}>
            ...
            <div>
                ...
                type="text"
                name="address" /*
                value={`${newMember.address?.street_name + ', ' + newMember.address?.street_number + ', ' + newMember.address?.post_code}`}
                onChange={handleChange} */ 
                />
            </div>
            <div className='place-self-end'>
            ...
            <button className='absolute bottom-6 right-10 px-4 py-1 bg-blue-100 border rounded-xl text-gray-600 hover:bg-blue-200 ease-in-out duration-300' onClick={handleSubmit}>Add Member</button>
            </div>
        </Modal>
        </div>
    );
